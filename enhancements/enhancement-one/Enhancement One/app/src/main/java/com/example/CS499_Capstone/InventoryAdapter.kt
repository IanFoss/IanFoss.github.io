...
class InventoryAdapter(
    ...
    private var itemList: MutableList<InventoryItemEntity>,
    ...
    fun setItems(newItems: MutableList<InventoryItemEntity>) {
        this.itemList = ArrayList<InventoryItemEntity>(newItems)
