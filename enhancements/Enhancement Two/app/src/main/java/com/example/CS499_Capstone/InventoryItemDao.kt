...
interface InventoryItemDao {
    ...
    @Query("SELECT * FROM inventory_table WHERE quantity <= :lowStockThreshold ORDER BY quantity")
    fun filterByLowStock(lowStockThreshold: Int): LiveData<List<InventoryItemEntity>>
