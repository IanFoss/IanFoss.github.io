...
class InventoryActivity : AppCompatActivity() {
    ...
    private val itemList: MutableList<InventoryItemEntity> = ArrayList<InventoryItemEntity>()
     ...
     override fun onCreate(savedInstanceState: Bundle?) {
        ...
        itemRepo.allItems.observe(
            this@InventoryActivity,
            Observer { items: MutableList<InventoryItemEntity> ->
                adapter.setItems(items)
            })


        // Floating action button to add item to inventory
        val fab = findViewById<FloatingActionButton>(R.id.add_item_fab)
